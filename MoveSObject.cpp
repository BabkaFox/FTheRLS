...
//        vSObject[t/30+1].setObjZ(t+vSObject[t/30].getObjZ());
        ...
        double x = (Vx*t+vSObject[t/30].getObjX());
        double y = (Vy*t+vSObject[t/30].getObjY());
        double z = (Vz*t+vSObject[t/30].getObjZ());
        //Содаем и заносим объекты
        vSObject.push_back(SObject(obj.getN(),obj.getVi(),obj.getGamma(),t,x,y,z,obj.getSizeObjX(),obj.getSizeObjX(),obj.getSizeObjX()));
    }
}
